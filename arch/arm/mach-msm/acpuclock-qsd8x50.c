...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	//*** { 256000, CCTL(CLK_GLOBAL_PLL, 3),	SRC_RAW, 0, 0, 1000, 29000 }, **// (Skip this)
...
int acpuclk_set_rate(unsigned long rate, enum setrate_reason reason) //** AXI **//
{
